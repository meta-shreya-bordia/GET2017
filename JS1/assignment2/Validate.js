...
function validateForm(){
  ...
  if(validateUserName(user_form[0]) && validateEmail(user_form[1]) && validateOption(user_form[2]) && validateOrganisationName(user_form[3]) && validateContactNumber(user_form[4]) && validateMessage(user_form[5])){
